...
from data_preprocess.data_process import read_langs, USE_CUDA, variables_from_pair, sos_token, eos_token
...
if __name__ == '__main__':
    ...
    n_layers = 2
    dropout_p = 0.05
    input_lang, output_lang, pairs = read_langs(lang1='cn', lang2='eng', reverse=False)
    ...
    for epoch in range(1, n_epoches + 1):
        ...
        if epoch % print_every == 0:
            ...
            print_summary = '%s (%d %d%%) %.4f' % (
                time_since(start, epoch / n_epoches), epoch, epoch / n_epoches * 100, print_loss_avg)
            print(print_summary)
